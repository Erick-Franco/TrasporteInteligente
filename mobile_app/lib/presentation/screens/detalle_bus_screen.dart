...
class _DetalleBusScreenState extends State<DetalleBusScreen> {
  ...
  Future<void> _cargarHistorial() async {
    ...
    try {
      ...
      // _historial = await busProvider.obtenerHistorial(widget.bus.conductorId);
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
            'Bus ${widget.bus.placa ?? widget.bus.conductorId?.substring(0, 5) ?? "?"}'),
            ...
            _buildSeccion(
              ...
              children: [
                _buildInfoTile(
                  ...
                  valor: widget.bus.conductorId ?? 'N/A',
                ),
                _buildInfoTile(
                  icon: Icons.route,
                  label: 'ID de Ruta',
